...
def main():
    ...
    trans = pd.read_csv('/tmp/pancreatic_transcriptomics.csv.gz')
    ...
    if args.copy:
        ...
        newcnv.to_csv('/tmp/pancreatic_copy_number.csv.gz',compression='gzip',index=False)
