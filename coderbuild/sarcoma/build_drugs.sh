...
python3 02_createSarcomaDrugsFile.py --token $SYNAPSE_AUTH_TOKEN -d $1 -o /tmp/sarcoma_drugs.tsv
...
python3 build_drug_desc.py --drugtable /tmp/sarcoma_drugs.tsv --desctable /tmp/sarcoma_drug_descriptors.tsv.gz
