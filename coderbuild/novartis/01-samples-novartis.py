...
def get_complete_novartis_sample_sheet(synObject):
...
if __name__ == "__main__":
    ...
    samplesheet = get_complete_novartis_sample_sheet(synObject)
    ...
    samplesheet.to_csv('/tmp/novartis_samples.csv', index=False)
