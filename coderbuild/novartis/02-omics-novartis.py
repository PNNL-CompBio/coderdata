...
def map_copy_number_novPDX(copy_number_data, improve_id_data, entrez_data):
    ...
    sample_entrez_cn_df['study'] = "novartis"
...
def map_transcriptomics_novPDX(transcriptomics_data, improve_id_data, entrez_data):
    ...
    sample_entrez_transcriptomics_df['study'] = "novartis"
...
def map_mutations_novPDX(mutation_data, improve_id_data, entrez_data):
    ...
    mutations_final['study'] = "novartis"
...
if __name__ == "__main__":
    ...
    if args.copy_number:
        ...
        if args.samples is None or args.samples=='':
            ...
            cn_df_final = map_copy_number_novPDX(copy_number_data = "/tmp/raw_copy_num_data.csv", improve_id_data = "/tmp/novartis_samples.csv", entrez_data = "/tmp/genes.csv")
            cn_df_final.to_csv("/tmp/novartis_copy_number.csv", index=False)
