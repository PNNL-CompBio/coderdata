...
python3 03-drugs-novartis.py --token $SYNAPSE_AUTH_TOKEN -d $1 -o /tmp/novartis_drugs.tsv
#python3 novar
#python3 03-drugs-novartispdx.py --token $SYNAPSE_AUTH_TOKEN -d $1 -o /tmp/novartispdx_drugs.tsv

echo "Running build_drug_desc.py..."
#for running locally: 
python3 build_drug_desc.py --drugtable /tmp/novartis_drugs.tsv --desctable /tmp/novartis_drug_descriptors.tsv.gz

gunzip /tmp/novartis_drug_descriptors.tsv.gz
