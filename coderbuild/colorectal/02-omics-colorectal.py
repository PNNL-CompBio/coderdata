...
def map_mutations(mutation_data, improve_id_data, entrez_data):
    ...
    mapped_mutation_data['study'] = "colorectal"
...
def map_transcriptomics(transciptomics_data, improve_id_data, entrez_data):
    ...
    mapped_transcriptomics_df['study'] = "colorectal"
...
def map_copy_number(copy_number_data, improve_id_data, entrez_data):
    ...
    improve_mapped_cn_df['study'] = "colorectal"
...
if __name__ == "__main__":
    ...
    if args.mutations:
        ...
        if args.ids is None or args.ids=='':
            ...
            mutation_df = map_mutations(mutation_data = "/tmp/mutation_data.csv", improve_id_data = "/tmp/colorectal_samples.csv", entrez_data = "/tmp/genes.csv")
            mutation_df.to_csv("/tmp/colorectal_mutations.csv", index=False)
    ...
    if args.copy_number:
        ...
        if args.ids is None or args.ids=='':
            ...
            mutation_df = map_copy_number(copy_number_data = "/tmp/copy_num_data.csv", improve_id_data = "/tmp/colorectal_samples.csv", entrez_data = "/tmp/genes.csv")
            mutation_df.to_csv("/tmp/colorectal_copy_number.csv", index=False)
