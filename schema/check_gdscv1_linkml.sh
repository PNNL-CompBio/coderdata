...
files=("/tmp/GDSCv1_samples.csv" "/tmp/GDSCv1_transcriptomics.csv" "/tmp/GDSCv1_proteomics.csv" "/tmp/GDSCv1_mutations.csv" "/tmp/GDSCv1_copy_number.csv" "/tmp/GDSCv1_experiments.csv" "/tmp/GDSCv1_drugs.tsv")
