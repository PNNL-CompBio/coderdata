...
files=("/tmp/gdscv1_samples.csv" "/tmp/gdscv1_transcriptomics.csv" "/tmp/gdscv1_proteomics.csv" "/tmp/gdscv1_mutations.csv" "/tmp/gdscv1_copy_number.csv" "/tmp/gdscv1_experiments.tsv" "/tmp/gdscv1_drugs.tsv")
