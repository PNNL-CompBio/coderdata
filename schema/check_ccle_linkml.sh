...
files=("/tmp/CCLE_samples.csv" "/tmp/CCLE_transcriptomics.csv" "/tmp/CCLE_proteomics.csv" "/tmp/CCLE_mutations.csv" "/tmp/CCLE_copy_number.csv" "/tmp/CCLE_experiments.csv" "/tmp/CCLE_drugs.tsv")
