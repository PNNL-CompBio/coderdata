...
files=("/tmp/gCSI_samples.csv" "/tmp/gCSI_transcriptomics.csv" "/tmp/gCSI_proteomics.csv" "/tmp/gCSI_mutations.csv" "/tmp/gCSI_copy_number.csv" "/tmp/gCSI_experiments.csv" "/tmp/gCSI_drugs.tsv")
