...
files=("/tmp/mpnst_samples.csv" "/tmp/mpnst_transcriptomics.csv" "/tmp/mpnst_proteomics.csv" "/tmp/mpnst_mutations.csv" "/tmp/mpnst_experiments.csv" "/tmp/mpnst_drugs.tsv")
