...
files=("/tmp/gdscv2_samples.csv" "/tmp/gdscv2_transcriptomics.csv" "/tmp/gdscv2_proteomics.csv" "/tmp/gdscv2_mutations.csv" "/tmp/gdscv2_copy_number.csv" "/tmp/gdscv2_experiments.tsv" "/tmp/gdscv2_drugs.tsv")
