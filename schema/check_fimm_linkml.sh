...
files=("/tmp/fimm_samples.csv" "/tmp/fimm_transcriptomics.csv" "/tmp/fimm_proteomics.csv" "/tmp/fimm_mutations.csv" "/tmp/fimm_copy_number.csv" "/tmp/fimm_experiments.tsv" "/tmp/fimm_drugs.tsv")
