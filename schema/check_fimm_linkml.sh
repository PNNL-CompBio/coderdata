...
files=("/tmp/FIMM_samples.csv" "/tmp/FIMM_transcriptomics.csv" "/tmp/FIMM_proteomics.csv" "/tmp/FIMM_mutations.csv" "/tmp/FIMM_copy_number.csv" "/tmp/FIMM_experiments.csv" "/tmp/FIMM_drugs.tsv")
