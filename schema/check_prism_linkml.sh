...
files=("/tmp/PRISM_samples.csv" "/tmp/PRISM_transcriptomics.csv" "/tmp/PRISM_proteomics.csv" "/tmp/PRISM_mutations.csv" "/tmp/PRISM_copy_number.csv" "/tmp/PRISM_experiments.csv" "/tmp/PRISM_drugs.tsv")
